const baseStyleRules = require('eslint-config-mandacarutech-base/rules/style').rules;
...
module.exports = {
  ...
  rules: {
    ...
    // TODO: set to "never" once babel-preset-mandacarutech supports public class fields
    'react/state-in-constructor': ['error', 'always'],

    // Enforces where React component static properties should be positioned
    // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/static-property-placement.md
    // TODO: set to "static public field" once babel-preset-mandacarutech supports public class fields
